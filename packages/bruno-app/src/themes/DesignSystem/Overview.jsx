  ...
  return (
    ...
    >
      ...
      <div style={{ marginBottom: '64px' }}>
        ...
        >
          A unified visual language for building consistent, accessible, and beautiful interfaces across AhaMan's ecosystem.
        </p>
  ...
  return (
    ...
    >
      ...
      <div style={{ marginBottom: '48px' }}>
        ...
        >
          Four carefully calibrated variants of AhaMan's brand color, each designed for a specific role in the interface.
        </p>
      </div>
        ...
        <div style={{ marginTop: '24px' }}>
          ...
          >
            ...
            >
              ...
              <div style={{ flex: 1, textAlign: 'center', fontSize: '12px', opacity: 0.5 }}>AhaMan</div>
            </div>
