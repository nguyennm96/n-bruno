      ...
      <div className="terminal-content">
        ...
        <div className="terminal-sessions-sidebar">
          <div className="terminal-sessions-header">
            <span>{t('DEVTOOLS.TERMINAL.SESSIONS')}</span>
            <IconPlus
              size={16}
              ...
              title={t('DEVTOOLS.TERMINAL.NEW_SESSION')}
            />
          </div>
          <div className="terminal-sessions-list">
            {isLoading ? (
              <div style={{ padding: '12px', color: '#888', fontSize: '13px' }}>{t('DEVTOOLS.TERMINAL.LOADING_SESSIONS')}</div>
            ) : sessions.length === 0 ? (
              <div style={{ padding: '12px', color: '#888', fontSize: '13px' }}>{t('DEVTOOLS.TERMINAL.NO_SESSIONS')}</div>
            ) : (
              <SessionList
                sessions={sessions}
        ...
        <div className="terminal-display-container">
          {!activeSessionId && window.ipcRenderer && (
            <div className="terminal-loading">
              ...
              <span>{t('DEVTOOLS.TERMINAL.NO_SESSION_SELECTED')}</span>
            </div>
          )}
          <div
            ref={onSessionMount}
