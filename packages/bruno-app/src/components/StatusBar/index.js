          ...
          <div className="status-bar-group">
            <ToolHint text={t('STATUS_BAR.preferences')} toolhintId="Preferences" place="top-start" offset={10}>
              <button
                ...
                tabIndex={0}
                aria-label={t('STATUS_BAR.openPreferences')}
              >
            ...
            <ThemeDropdown>
              <button
                ...
                data-trigger="theme"
                tabIndex={0}
                aria-label={t('STATUS_BAR.changeTheme')}
              >
            ...
            <ToolHint text={t('STATUS_BAR.githubRepository')} toolhintId="GitHub" place="top" offset={10}>
              <button
                className="status-bar-button"
                onClick={() => {
                ...
                tabIndex={0}
                aria-label={t('STATUS_BAR.openGithubRepository')}
              >
        ...
        <div className="status-bar-section">
          <div className="flex items-center gap-3">
            <button
              ...
              tabIndex={0}
              aria-label={t('STATUS_BAR.globalSearch')}
            >
            ...
            <button
              ...
              tabIndex={0}
              aria-label={t('STATUS_BAR.openCookies')}
            >
              <div className="console-button-content">
            ...
            <button
              ...
              tabIndex={0}
              aria-label={errorCount > 0 ? t('STATUS_BAR.openDevToolsWithErrors', { count: errorCount }) : t('STATUS_BAR.openDevTools')}
            >
              <div className="console-button-content">
                <IconTool size={16} strokeWidth={1.5} aria-hidden="true" />
                <span className="console-label">{t('STATUS_BAR.devTools')}</span>
                {errorCount > 0 && (
