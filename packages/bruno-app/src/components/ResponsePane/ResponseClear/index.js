...
const ResponseClear = forwardRef(({ collection, item, children }, ref) => {
  ...
  return (
    <div ref={elementRef} onClick={clearResponse} title={!children ? t('RESPONSE_PANE.ACTIONS.CLEAR_RESPONSE') : null} data-testid="response-clear-btn">
      {children ? children : (
        <StyledWrapper className="flex items-center">
          <ActionIcon className="p-1" label={t('RESPONSE_PANE.ACTIONS.CLEAR_RESPONSE')}>
