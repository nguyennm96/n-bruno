  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      name: Yup.string()
        ...
        .test('duplicate-name', t('WORKSPACE_ENVIRONMENTS.GLOBAL_ENV_ALREADY_EXISTS'), validateEnvironmentName)
    }),
    onSubmit: (values) => {
      dispatch(addGlobalEnvironment({ name: values.name }))
        .then(() => {
          toast.success(t('WORKSPACE_ENVIRONMENTS.GLOBAL_ENV_CREATED'));
          onClose();
        ...
        .catch(() => toast.error(t('WORKSPACE_ENVIRONMENTS.ENVIRONMENT_CREATE_ERROR')));
    }
  });
